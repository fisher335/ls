...
while flag:
    ...
    url = "https://api.github.com/repos/PaddlePaddle/models/issues?state=open&page={pn}&per_page=20".format(pn=page_num)
    print(url)
...
pd_book.to_excel('issues.xlsx', sheet_name='modle')
